    ...
    return (
        <footer className="bg-[#050505] text-white py-24 border-t border-white/10 w-full">
            <div className="container mx-auto px-6 flex flex-col items-center">
                ...
                {/* Centered Logo Section - Original Color */}
                <div className="flex flex-col items-center mb-16 group">
                    ...
                    <div className="w-24 h-1 bg-[#fbc5fa] mt-8 opacity-50"></div>
                </div>

                {/* Footer Navigation Menú */}
                <div className="grid grid-cols-2 md:grid-cols-3 gap-16 w-full max-w-4xl text-left border-t border-white/5 pt-16">
                    <div>
                        <h3 className="text-[11px] font-black uppercase tracking-[0.5em] text-[#fbc5fa] mb-8 italic">Explorar</h3>
                        <ul className="space-y-4 text-[10px] uppercase tracking-[0.3em] text-white/40 font-bold">
                            ...
                            <li><button onClick={() => onNavigate('products', 'all')} className="hover:text-white transition-colors">Tienda Boutique</button></li>
                        </ul>
                    </div>

                    <div>
                        <h3 className="text-[11px] font-black uppercase tracking-[0.5em] text-[#fbc5fa] mb-8 italic">Soporte VIP</h3>
                        <ul className="space-y-4 text-[10px] uppercase tracking-[0.3em] text-white/40 font-bold">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <h3 className="text-[11px] font-black uppercase tracking-[0.5em] text-[#fbc5fa] mb-8 italic">Comunidad</h3>
                        <ul className="space-y-4 text-[10px] uppercase tracking-[0.3em] text-white/40 font-bold">
